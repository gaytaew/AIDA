...
const els = {
    ...
    selects: {
        ...
        haptics: document.getElementById('param-haptics'),
    ...
    try {
        const payload = {
            params: {
                ...
                haptics: els.selects.haptics?.value || '',
