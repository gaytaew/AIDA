...
const WEATHER_LIGHTING = {
  ...
  options: [
    ...
    { 
      ...
      desc: 'Облака на небе',
      narrative: "Погода: переменная облачность — белые облака на голубом небе"
    },
    { 
      value: 'overcast', 
      label: 'Пасмурно', 
    ...
    { 
      value: 'snowy', 
      label: 'Снег', 
      desc: 'Заснеженные поверхности',
      narrative: "Погода: снег — заснеженные поверхности, белый снег лежит на земле и объектах"
    },
    { 
      value: 'stormy', 
      label: 'Гроза/шторм', 
...
const SEASON = {
  ...
  options: [
    ...
    { 
      ...
      narrative: "Сезон: зима — голые деревья без листьев, снег на земле и ветках"
    },
    { 
      value: 'late_autumn', 
      label: 'Поздняя осень', 
