...
const WEATHER_LIGHTING = {
  id: 'weatherLighting',
  label: 'Погода',
  description: 'Погодные условия — влияют на контекст и окружение',
  options: [
    { 
      value: 'clear', 
      label: 'Ясно', 
      desc: 'Чистое небо, солнечный день',
      narrative: "Погода: ясно — чистое голубое небо, солнечный день"
    },
    { 
      value: 'partly_cloudy', 
      label: 'Переменная облачность', 
      desc: 'Облака на небе',
      narrative: "Погода: переменная облачность — облака на небе, меняющийся свет"
    },
    { 
      value: 'overcast', 
      label: 'Пасмурно', 
      desc: 'Серое небо, облака',
      narrative: "Погода: пасмурно — серое облачное небо"
    },
    { 
      value: 'foggy', 
      label: 'Туман/дымка', 
      desc: 'Атмосферный туман',
      narrative: "Погода: туман — атмосферная дымка, ограниченная видимость вдаль"
    },
    { 
      value: 'rainy', 
      label: 'Дождь', 
      desc: 'Мокрые поверхности, капли',
      narrative: "Погода: дождь — капли дождя, мокрые поверхности, блестящий асфальт"
    },
    { 
      value: 'snowy', 
      label: 'Снег', 
      desc: 'Падающий снег, заснеженные поверхности',
      narrative: "Погода: снег — падающие снежинки, белые заснеженные поверхности"
    },
    { 
      value: 'stormy', 
      label: 'Гроза/шторм', 
      desc: 'Драматичное небо, тёмные тучи',
      narrative: "Погода: гроза — драматичное небо с тёмными тучами, возможны молнии на горизонте"
    },
    { 
      value: 'windy', 
      label: 'Ветрено', 
      desc: 'Сильный ветер, движение',
      narrative: "Погода: ветрено — сильный ветер, развевающиеся волосы и ткани"
    },
    { 
      value: 'hazy', 
      label: 'Дымка/смог', 
      desc: 'Городской смог, пониженная видимость',
      narrative: "Погода: дымка — городской смог или лёгкий туман, приглушённые дали"
    },
    { 
      value: 'indoor', 
      label: 'В помещении', 
      desc: 'Интерьер, не зависит от погоды',
      narrative: "В помещении — контролируемые условия интерьера"
    }
  ]
};
...
const SEASON = {
  id: 'season',
  label: 'Сезон',
  description: 'Время года — влияет на окружение и атмосферу',
  options: [
    { 
      value: 'spring', 
      label: 'Весна', 
      desc: 'Свежая зелень, цветение',
      narrative: "Сезон: весна — свежая молодая зелень, цветущие деревья, пастельные тона природы"
    },
    { 
      value: 'summer', 
      label: 'Лето', 
      desc: 'Густая зелень, жаркая атмосфера',
      narrative: "Сезон: лето — густая яркая зелень, насыщенные цвета природы, жаркая атмосфера"
    },
    { 
      value: 'autumn', 
      label: 'Осень', 
      desc: 'Золотая листва, тёплые тона',
      narrative: "Сезон: осень — золотая и красная листва, опавшие листья, меланхоличная атмосфера"
    },
    { 
      value: 'winter', 
      label: 'Зима', 
      desc: 'Снег, минималистичный пейзаж',
      narrative: "Сезон: зима — минималистичный пейзаж, снег или голые деревья, холодная атмосфера"
    },
    { 
      value: 'late_autumn', 
      label: 'Поздняя осень', 
      desc: 'Голые деревья, серое небо',
      narrative: "Сезон: поздняя осень — голые деревья, опавшая листва, холодная сырая атмосфера"
    },
    { 
      value: 'early_spring', 
      label: 'Ранняя весна', 
      desc: 'Тающий снег, первые ростки',
      narrative: "Сезон: ранняя весна — тающий снег, первые ростки, переходная атмосфера"
    },
    { 
      value: 'any', 
...
const UNIVERSE_PARAMS = {
  ...
  // Блок 8: Контекст локации (погода, сезон — влияют на окружение)
  context: {
...
function getBlocksStructure() {
  return [
    ...
    },
    {
      id: 'lighting',
      label: '💡 Освещение',
      description: 'Источник, направление, качество света (НЕ зависит от позы!)',
      params: ['lightSource', 'lightDirection', 'lightQuality', 'timeOfDay']
    },
    {
      id: 'context',
      label: '🌍 Контекст локации',
      description: 'Погода и сезон — окружение и атмосфера',
      params: ['weatherLighting', 'season']
    },
    {
      id: 'antiAi',
      label: '🤖 Реализм',
