...
const TECHNICAL_VALUES = {
  ...
  weatherLighting: {
    ...
    snowy: 'Snowy — snow-covered surfaces, white snow on ground and objects',
  ...
  season: {
    ...
    winter: 'Winter — bare trees without leaves, snow on ground and branches',
...
const DESCRIPTIVE_EFFECTS = {
  ...
  weatherLighting: {
    ...
    snowy: 'Снег — заснеженные поверхности, белый снег на земле и объектах',
  ...
  season: {
    ...
    winter: 'Зимняя атмосфера — голые деревья без листьев, снег на земле и ветках',
